    ...
    return (
      <>
        ...
        <div className="row justify-content-center">
          <h1 className="mt-3">{hexaganoContent?.titulo}</h1>
  ...
  function renderAssentamento() {
    ...
    return (
      <>
        ...
        <div className="row">
          <h1 className="mt-2">{assentamentoContent?.titulo}</h1>
          <Card className="pers-card col-5">
            <Card.Body>
  ...
  function renderRuinas() {
    ...
    return (
      <>
        ...
        <div className="row">
          <h1 className="mt-2">{ruinas?.titulo}</h1>
          <div className="col-7">
            <div className="row">
              <Card className="pers-card col-3">
                <Card.Body>
              ...
              <Card className="pers-card col-4">
                <Card.Body>
